...
INSERT INTO "new_AccountDailySummary" ("accountId", "applications", "createdAt", "dateKey", "entries", "fees", "id", "outputs", "rescues", "updatedAt", "yields") SELECT "accountId", "applications", "createdAt", "dateKey", "entries", "fees", "id", "outputs", "rescues", "updatedAt", "yields" FROM "AccountDailySummary";
